...
export default function Contact() {
  return (
    <section id="contact" className="
        ...
        <Link className="flex gap-2 items-center md:justify-normal" href="https://github.com/Lawhornmatt">
          <GitHubIcon />
          <span className='hidden md:inline lg:text-3xl'>Git Hub</span>
        </Link>

        <Link className="flex gap-2 items-center md:justify-normal" href="https://www.linkedin.com/in/matthew-lawhorn/">
          <LinkedInIcon />
          <span className='hidden md:inline lg:text-3xl'>LinkedIn</span>
        </Link>

        <Link className="flex gap-2 items-center md:justify-normal" href="https://federate.social/@lawhornmatt">
          <MastodonIcon />
          <span className='hidden md:inline lg:text-3xl'>Mastodon</span>
        </Link>

        <Link className="flex gap-2 items-center md:justify-normal" href="mailto:lawhornmatt@proton.me">
          <EmailIcon />
